...
const SIGNAL_LENS_EDITOR_PANEL = preload(
	"res://addons/signal_lens/editor/signal_lens_editor_panel.tscn"
)
...
func _enable_plugin():
	add_autoload_singleton(
		AUTOLOAD_NAME, "res://addons/signal_lens/autoload/signal_lens_autoload.gd"
	)
